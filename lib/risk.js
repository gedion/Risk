 ...
 * @returns {Player}
 */
Risk.prototype.getCurrentPlayer = function() {
	var numOfPlayers = this.getPlayers().length,
	    turn = this.getTurn();
	return this._config['players'][turn];
}
/**
...
Risk.prototype.getCurrentPlayerStatus = function() {
 return this.getCurrentPlayer().getStateMachine().current;
}
